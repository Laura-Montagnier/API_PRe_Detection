...
class FeatureType(object):
    ...
    def feature_vector(self, bytez, lief_binary):
        ...
        if self.raw_features(bytez, lief_binary) is None:
            return None
        else :
...
class PEFeatureExtractor(object):
    ...
    def raw_features(self, bytez):
        ...
        for fe in self.features:
            a=fe.raw_features(bytez, lief_binary)
            if a is None:
                return None
            else :
                features.update({fe.name: a})
        return features
    ...
    def feature_vector(self, bytez):
        a = self.raw_features(bytez)
        if a is None:
            return None
        else:
            return self.process_raw_features(a)
